...
fn test_projects_delete() -> Result<(), Error> {
    let mut p = spawn("./target/debug/zero-cli projects delete --id dd6c", Some(15000))?;
    p.exp_string("Type")?;
...
fn test_projects_edit() -> Result<(), Error> {
    let mut p = spawn("./target/debug/zero-cli projects edit --id dc3c", Some(15000))?;
...
fn test_projects_share() -> Result<(), Error> {
    let mut p = spawn("./target/debug/zero-cli projects share --id dc1c", Some(15000))?;
...
fn test_projects_usage_list() -> Result<(), Error> {
    let mut p = spawn("./target/debug/zero-cli projects usage list --id dc1c", Some(15000))?;
...
fn test_projects_usage_details() -> Result<(), Error> {
    let mut p = spawn("./target/debug/zero-cli projects usage details --id 7c15", Some(15000))?;
...
fn test_projects_view() -> Result<(), Error> {
    let mut p = spawn("./target/debug/zero-cli projects view --id dc1c", Some(15000))?;
    p.exp_string("Name")?;
